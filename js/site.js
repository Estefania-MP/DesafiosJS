...
//Añado array para organizar los productos y genero prompt y alert para interactuar con el usuario y que genere la compra, ademas sumo funciones de alto orden vistas en la ultima clase
...
let seleccionProductos = prompt("Indicacanos con si o no si queres saber cuales son nuestros productos!")
...
while (seleccionProductos != "no"){
    ...
    while(seleccionProductos === "no"){
        alert("Perfecto! Gracias por la compra")
